...
class _LoginPageState extends State<LoginPage>{
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        Container(
          ...
          padding: EdgeInsets.symmetric(horizontal: screenwidth * 0.35, vertical: screenheight * 0.2),
          child: Column(
  ...
  void _signIn() async {
    var driverID = ""; // Assign a default empty string
    setState(() {
      isSigningUp = true;
    ...
    if (user != null) {
      ...
      driverID = await getDriverId(email) ?? "";
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => Requests(driverID: driverID)),
      );
    } else {
      setState(() {
