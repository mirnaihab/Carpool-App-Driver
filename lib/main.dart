...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Container(
        width: screenWidth, // Set the container width to match the screen width
        height: screenheight, // Set the container height to match the screen height
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Lottie.network(
                "https://lottie.host/e1a19c07-86ff-4bd6-8820-793dd7875895/uo8W0o7UdM.json",
                width: screenWidth*0.5, // Set your preferred width
                height: screenheight*0.5, // Set your preferred height
              ),
